...
**AI 应用开发工程师 / Python 后端开发工程师**

来自杭州 / 武汉，从嵌入式到 LLM 平台，跨越硬件与 AI 的全栈工程师。专注模型推理部署与 AI 应用工程化，让大模型在真实业务中稳定运行。
...
<div class="card h-100">
<div class="card-body">
<h3 class="card-title">NexusMind AI 训推一体化平台</h3>
<div class="project-meta">2026.03 – 至今 · LLM 平台 · FastAPI / React / vLLM</div>
<ul>
<li><strong>全栈 Monorepo</strong>：前后端一体化开发，OpenAI 兼容 Chat API，支持流式/非流式 + Thinking 推理模式。</li>
<li><strong>可插拔推理后端</strong>：vLLM (GPU) / MLX (Apple Silicon) 硬件自动选择，模型注册表全生命周期管理。</li>
<li><strong>IntentOS</strong>：Monaco Editor + Verilog 编译/仿真/综合/Lint + AI Agent 对话的在线编程环境。</li>
<li><strong>模型评测</strong>：集成 lm-eval 多基准评测 + MT-Bench 对话评测，Celery 异步任务调度。</li>
<li><strong>技术栈</strong>：FastAPI、React、PostgreSQL、Redis、Celery、vLLM、MLX</li>
</ul>
</div>
</div>
:::
...
<div class="timeline-title">亿方杭创 · AI 应用开发工程师</div>
<div class="timeline-meta">2026.03 – 至今</div>
<ul>
<li><strong>LLM 训推平台</strong>：全栈开发 AI 训推一体化平台，涵盖 OpenAI 兼容 Chat API（流式/非流式 + Thinking 模式）、模型全生命周期管理。</li>
<li><strong>推理服务</strong>：实现可插拔推理后端（vLLM GPU / MLX Apple Silicon 自动切换），模型评测（lm-eval + MT-Bench）。</li>
<li><strong>在线编程环境</strong>：开发 IntentOS Verilog 在线编程平台（Monaco Editor + EDA 工具链 + AI Agent 对话）。</li>
<li><strong>技术栈</strong>：FastAPI、React、PostgreSQL、Redis、Celery、vLLM、MLX、Docker Compose</li>
</ul>
</div>
