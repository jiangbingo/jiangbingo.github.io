...
<li><strong>Verilog AI 辅助编程</strong>：Monaco Editor + 编译/仿真/综合/Lint + AI Agent 对话的在线编程环境。</li>
...
<li><strong>Verilog AI 辅助编程</strong>：开发 Verilog 在线编程平台（Monaco Editor + EDA 工具链 + AI Agent 对话）。</li>
